...
public interface ConfigurationNodeSource {
	/**
	 * Gets a child of the current node. Remember that this returns a DIRECT child, without splitting at the
	 * {@link com.alta189.cyborg.api.util.config.Configuration#getPathSeparator()}
	 *
	...
	/**
	 * Adds the provided node as a child to this one As with the other methods handling children, this method only
	...
	/**
	 * Add the given children. The process for adding children is the same as that for
	 * {@link #addChild(ConfigurationNode)}
	 *
	...
	/**
	 * Return the raw Object values of this node's children ConfigurationNodes are converted into Map<String,
	 * Object>s for the result of this method
	 *
	...
	/**
	 * Return the keys in this configuration. If {@code deep} is true, this will also include paths from child
	 * nodes, joined by {@link com.alta189.cyborg.api.util.config.Configuration#getPathSeparator()} Keys returned
	...
	/**
	 * Returns the node at the specified child path, splitting by the configuration's path separator. This can
	 * return both direct children and indirect children.
	 *
	 * @param path The path to get a node at
	 * @return The node at the specified path
	 * @see #getNode(String...) for more information on how this method behaves. (This is also the method called
	 * when a path given contains the path separator)
	 */
	public ConfigurationNode getNode(String path);

	/**
	 * Get a child node of this node source, going across multiple levels. If there is no node at the specified path
	 * a detached configuration node will be returned, which will be attached to {@link #getConfiguration()} if its
	 * value is set or a child is added.
	 *
	...
	/**
	 * Returns the configuration this node source is attached to. This may return the same object if this
	 * {@link ConfigurationNodeSource} is a Configuration.
	 *
	...
	/**
	 * Returns the elements of the configuration path going to this node source. Can return an empty array if we are
